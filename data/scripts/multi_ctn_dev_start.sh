...
SHM_SIZE="2G"
USER_SPECIFIED_MAPS=
# MAP_VOLUMES_CONF="--volume apollo_map_volume-san_mateo:/apollo/modules/map/data/san_mateo --volume apollo_map_volume-sunnyvale_loop:/apollo/modules/map/data/sunnyvale_loop"
MAP_VOLUMES_CONF=
OTHER_VOLUMES_CONF=
