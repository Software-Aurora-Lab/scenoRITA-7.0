...
_MONITORMESSAGEITEM_MESSAGESOURCE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="CANBUS", index=1, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CONTROL", index=2, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DECISION", index=3, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LOCALIZATION", index=4, number=5, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PLANNING", index=5, number=6, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PREDICTION", index=6, number=7, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SIMULATOR", index=7, number=8, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="HWSYS", index=8, number=9, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ROUTING", index=9, number=10, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="MONITOR", index=10, number=11, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="HMI", index=11, number=12, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RELATIVE_MAP", index=12, number=13, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="GNSS", index=13, number=14, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CONTI_RADAR", index=14, number=15, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RACOBIT_RADAR",
            index=15,
        ...
        _descriptor.EnumValueDescriptor(
            name="MOBILEYE", index=17, number=18, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DELPHI_ESR", index=18, number=19, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STORYTELLING", index=19, number=20, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TASK_MANAGER", index=20, number=21, serialized_options=None, type=None
        ),
    ],
...
_MONITORMESSAGEITEM_LOGLEVEL = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="INFO", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="WARN", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ERROR", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FATAL", index=3, number=3, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
