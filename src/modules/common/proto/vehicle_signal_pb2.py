...
_VEHICLESIGNAL_TURNSIGNAL = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="TURN_NONE", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TURN_LEFT", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TURN_RIGHT", index=2, number=2, serialized_options=None, type=None
        ),
    ],
