...
_CMDTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="START", index=0, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CHECK", index=1, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STOP", index=2, number=3, serialized_options=None, type=None
        ),
    ],
...
_DATATYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="MAP_MAKING", index=0, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="MAP_CHECKOUT", index=1, number=2, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
