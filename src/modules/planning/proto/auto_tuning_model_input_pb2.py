...
_PATHPOINTWISEFEATURE_BOUNDRELATEDFEATURE_CROSSABLELEVEL = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="CROSS_FREE", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CROSS_ABLE", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_SPEEDPOINTWISEFEATURE = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _SPEEDPOINTWISEFEATURE_OBSTACLEFEATURE,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
