...
_DRIVINGACTION = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="NONE", index=0, number=100, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FOLLOW", index=1, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CHANGE_LEFT", index=2, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CHANGE_RIGHT", index=3, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PULL_OVER", index=4, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STOP", index=5, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RESUME_CRUISE", index=6, number=5, serialized_options=None, type=None
        ),
    ],
