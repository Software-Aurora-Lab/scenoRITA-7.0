...
_TRAFFICRULECONFIG_RULEID = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="CROSSWALK", index=1, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DESTINATION", index=2, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="KEEP_CLEAR", index=3, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            name="REROUTING", index=5, number=6, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STOP_SIGN", index=6, number=7, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TRAFFIC_LIGHT", index=7, number=8, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="YIELD_SIGN", index=8, number=9, serialized_options=None, type=None
        ),
    ],
