...
_LANEPOINT_SCENARIOTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="URBAN_ROAD", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="JUNCTION", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="HIGHWAY", index=2, number=2, serialized_options=None, type=None
        ),
    ],
...
_LANESEQUENCE_BEHAVIORTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="NOT_GOTO_LANE", index=0, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CONSTANT_SPEED", index=1, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
