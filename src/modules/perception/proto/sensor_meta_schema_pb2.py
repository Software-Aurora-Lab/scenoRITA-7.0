...
_SENSORMETA_SENSORTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="VELODYNE_64", index=1, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="VELODYNE_32", index=2, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="VELODYNE_16", index=3, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LDLIDAR_4", index=4, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LDLIDAR_1", index=5, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            name="STEREO_CAMERA", index=9, number=8, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ULTRASONIC", index=10, number=9, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="VELODYNE_128", index=11, number=10, serialized_options=None, type=None
        ),
    ],
...
_SENSORMETA_SENSORORIENTATION = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="FRONT", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LEFT_FORWARD", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LEFT", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LEFT_BACKWARD", index=3, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="REAR", index=4, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RIGHT_BACKWARD", index=5, number=5, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RIGHT", index=6, number=6, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RIGHT_FORWARD", index=7, number=7, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PANORAMIC", index=8, number=8, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
