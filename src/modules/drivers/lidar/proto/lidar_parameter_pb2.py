...
_LIDARPARAMETER_LIDARBRAND = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="VELODYNE", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="HESAI", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ROBOSENSE", index=2, number=2, serialized_options=None, type=None
        ),
    ],
