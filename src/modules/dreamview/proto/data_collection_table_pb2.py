...
_COMPARISONOPERATOR = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="NOT_EQUAL", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="GREATER_THAN", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_DATACOLLECTIONTABLE = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _DATACOLLECTIONTABLE_SCENARIOENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
