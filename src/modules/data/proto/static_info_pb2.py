...
_VEHICLEINFO_BRAND = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="LINCOLN", index=0, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FORD", index=1, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LEXUS", index=2, number=3, serialized_options=None, type=None
        ),
    ],
...
_VEHICLEINFO_MODEL = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="MKZ", index=0, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TRANSIT", index=1, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RX450H", index=2, number=3, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
